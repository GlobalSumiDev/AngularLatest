...
@Component({
  selector: 'app-bankfinancialwhite',
  standalone: true,
  imports: [SidebarComponent, CommonModule, InnerbannerComponent],
  templateUrl: './bankfinancialwhite.component.html',
  styleUrl: './bankfinancialwhite.component.scss'
})
export class BankfinancialwhiteComponent {
